...
## https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/callback/__init__.py
  ...
  def v2_runner_on_ok(self, result):
    ...
    """
    self._display.display("###################### v2_runner_on_ok INVOKED ##############################")
    ## Extract module name
    module_name = ''
    module_args = {}
    ...
    if (module_name == 'junos_jsnapy' or module_name == 'juniper_junos_jsnapy') and ( module_args['action'] == 'snapcheck' or module_args['action'] == 'check' ):
